...
public interface IGenericDAO<T extends Persistente, E extends Serializable> {
     ...
     * @throws main.java.exceptions.TipoChaveNaoEncontradaException
     * @throws main.java.exceptions.DAOException
     */
    public Boolean cadastrar(T entity) throws TipoChaveNaoEncontradaException, DAOException,
            main.java.exceptions.TipoChaveNaoEncontradaException, main.java.exceptions.DAOException;
